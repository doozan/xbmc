...
namespace JSONRPC
{
  ...
  const char* const JSONRPC_SERVICE_METHODS[] = {  
    ...
    "\"Scraper.GetScrapers\": {"
      "\"type\": \"method\","
      "\"description\": \"Retrieve list of available scrapers\","
      "\"transport\": \"Response\","
      "\"permission\": \"ReadData\","
      "\"params\": ["
        "{ \"name\": \"type\", \"type\": \"string\", \"required\": true, \"enum\": [ \"albums\", \"artists\", \"movies\", \"tvshows\", \"musicvideos\", \"library\"] }"
      "],"
      "\"returns\": {"
        "\"type\": \"object\","
    ...
    "\"Scraper.FindMovie\": {"
      "\"type\": \"method\","
      "\"description\": \"Retrieve matching items\","
      "\"transport\": \"Response\","
      "\"permission\": \"ReadData\","
      "\"params\": ["
        "{ \"name\": \"scraperid\", \"type\": \"string\", \"required\": true },"
